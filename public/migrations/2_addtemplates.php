...
class addtemplates extends \crisp\core\Migrations {

    public function run() {
        try {
            $this->begin();
            $this->createTable("crispy_templates",
                array("id", $this::DB_INTEGER, "NOT NULL SERIAL"),
                array("name", $this::DB_VARCHAR, "NOT NULL"),
                array("directory", $this::DB_VARCHAR, "NOT NULL"),
                array("content", $this::DB_TEXT, "DEFAULT NULL"),
                array("author", $this::DB_BIGINT, "NOT NULL"),
                array("layout", $this::DB_BIGINT, "DEFAULT NULL"),
